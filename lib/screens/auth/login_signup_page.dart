...
import 'package:lawimmunity/screens/auth/otp_verficiation_page.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              PhoneInputField(onPhoneChanged: (phone){
                setState(() {
                  userPhone = phone;
                });
              },),
              ...
              Center(
                child: RaisedGradientButton(
                  userPhone.isNotEmpty && userPhone.length > 5 ? "CONTINUE " : "ENTER PHONE",
                  onPressed: () {
